// firebase-messaging-sw.js  (compat, con tracking delivered/read + id)
// --------------------------------------------------------------------
...
function normalizeData(raw = {}) {
  const d = raw.data || {};
  return {
    id:    d.id ? String(d.id) : undefined, // necesario para delivered/read
...
// Llega en **background** (app NO enfocada)
messaging.onBackgroundMessage((payload) => {
  ...
  return self.registration.showNotification(d.title, {
    ...
    renotify: true,
    data: { id: d.id, url: d.url }  // guardamos id/url para el click
  });
});
